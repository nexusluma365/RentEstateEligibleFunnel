...
After the questionnaire, `results-processing.html` runs the analysis loader and sends the user to `rentready-review-checkout.html` for the one-time $10 RentReady review checkout. A confirmed Stripe PaymentIntent unlocks `after-payment-results/index.html`.
